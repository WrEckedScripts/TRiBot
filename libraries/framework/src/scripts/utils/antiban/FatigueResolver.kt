...
object FatigueResolver {
    ...
    fun getMilliseconds(
        ...
        // Override any props, for unhandled waits by us, to still ensure our Fatigue system is in effect.
        ...
        this.logger?.warn(
            "[Fatigue] - factor: ${factor} | mean: ${adjustedMean} | sd: ${adjustedSd} | calculatedDelay: ${
                calculateDelay(
                    adjustedMean,
                    adjustedSd
                ).first
